...
render() {
  return (
    ...
    <h2 className="curriculum"> CURRICULUM VITAE </h2>
    <div className="cv-part-line"> </div>

    <div className="exp">
      <div className="text">
        <h3 className="subtitle"> LE WAGON </h3>
  ...
  <path d="M236.968 3.85318L236.524 300.423L299.524 300.517L299.968 3.94741L236.968 3.85318Z" stroke="#FFBBBB" stroke-width="7"/>
    ...
    <div className="text">
      <h3 className="subtitle"> RENTMAN </h3>
      <p> jefzf. fzeoifhze lfn nef lf jz </p>
      </div>
    </div>
    ...
    <div className="exp">
    <div className="text">
      <h3 className="subtitle"> PEEMZ APP </h3>
      <p> jefzf. fzeoifhze lfn nef lf jz </p>
      </div>
      <div className="jaune2" > </div>
    </div>
    ...
    <div className="jaune2" > </div>
    <div className="text">
      <h3 className="subtitle"> PARIS-DAUPHINE </h3>
      <p> jefzf. fzeoifhze lfn nef lf jz </p>
      </div>
    </div>
